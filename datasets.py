...
if __name__ == '__main__':
    print('test')
    d = PartDataset(root = 'pointGAN/shapenetcore_partanno_segmentation_benchmark_v0', class_choice = ['Chair'])
    print(len(d))
    ps, seg = d[0]
    print(ps.size(), ps.type(), seg.size(),seg.type())
    print(torch.mean(ps, 0))
    d = PartDataset(root = 'pointGAN/shapenetcore_partanno_segmentation_benchmark_v0', classification = True)
    print(len(d))
    ps, cls = d[0]
